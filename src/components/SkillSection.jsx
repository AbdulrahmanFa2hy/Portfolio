        ...
        {skills.map((skill, index) => {
          ...
          return (
            <motion.div
              ...
              key={index}
              title={skill.name}
              className="flex items-center justify-center gap-4 p-4 origin-center transform border rounded-sm sm:justify-start bg-transparent hover:bg-[#121519] border-neutral-700 md:origin-top"
            >
