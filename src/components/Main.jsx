...
function Main() {
  return (
    ...
    >
      <div className="flex flex-col justify-center sm:w-[55%] lg:max-w-[46%] z-10">
        ...
        <Typewriter />
        <div className=" text-justify leading-loose font-[400] sm:text-[1rem] text-[#f1f1f1]">
      ...
      <div className="flex flex-col gap-5 sm:gap-10 lg:flex-row">
